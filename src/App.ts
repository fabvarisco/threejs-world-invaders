...
import WebWorldPrefab from "./assets/WebWorldPrefab";
import InvaderPrefab from "./assets/InvaderPrefab";
import EarthPrefab from "./assets/EarthPrefab";
import GunPrefab from "./assets/GunPrefab";
